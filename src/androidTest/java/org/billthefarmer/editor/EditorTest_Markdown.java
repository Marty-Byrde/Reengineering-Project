...
public class EditorTest_Markdown {
    ...
    @Test
    public void editorTest_Markdown() {
        ...
        ViewInteraction textView = onView(
                allOf(withId(android.R.id.title), withText("View markdown…"),
                        childAtPosition(
                                childAtPosition(
        ...
        ViewInteraction editText2 = onView(
                allOf(withId(R.id.text), withText("<!DOCTYPE html>\n<html>\n<head>\n<meta charset=\"utf-8\">\n<meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\">\n</head>\n<body>\n<p>test</p>\n\n</body>\n</html>\n"),
                        withParent(allOf(withId(R.id.hscroll),
                                withParent(withId(R.id.vscroll)))),
                        isDisplayed()));
        editText2.check(matches(withText("<!DOCTYPE html>\n<html>\n<head>\n<meta charset=\"utf-8\">\n<meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\">\n</head>\n<body>\n<p>test</p>\n\n</body>\n</html>\n")));
    }
