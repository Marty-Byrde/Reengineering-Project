...
public class EditorTest_Codec {
    ...
    public void editorTest_Codec() {
                        ...
                        childAtPosition(
                                allOf(withId(R.id.hscroll),
                                        childAtPosition(
                                                ...
                                                0)),
                                0)));
        editText.perform(scrollTo(), replaceText("text"), closeSoftKeyboard());
        ...
        editText2.perform(replaceText("Documents/Codec_"+time+".txt"));

        ViewInteraction editText3 = onView(
                allOf(withId(R.id.pathText), withText("Documents/Codec_"+time+".txt"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.custom),
                                        0),
        ...
        ViewInteraction textView = onView(
                allOf(withId(android.R.id.title), withText("UTF-8"),
                        childAtPosition(
                                childAtPosition(
        ...
        ViewInteraction textView2 = onView(
                allOf(withId(android.R.id.title), withText("IBM-Thai"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction editText4 = onView(
                allOf(withId(R.id.text), withText("ธฒผธ\n"),
                        withParent(allOf(withId(R.id.hscroll),
                                withParent(withId(R.id.vscroll)))),
                        isDisplayed()));
        editText4.check(matches(withText("ธฒผธ\n")));
    }
